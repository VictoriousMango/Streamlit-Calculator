...
# Row 4
bOB = col41.button('(', use_container_width=True, on_click=_1)
b0 = col42.button('0', use_container_width=True, on_click=_1)
bCB = col43.button(')', use_container_width=True, on_click=_1)
# Row 5
bAdd = col51.button(' \+ ', use_container_width=True, on_click=_1)
bMinus = col52.button(' \- ', use_container_width=True, on_click=_1)
bMultiply = col53.button(' \* ', use_container_width=True, on_click=_1)
bDivide = col54.button(' / ', use_container_width=True, on_click=_1)
bModulo = col55.button(' % ', use_container_width=True, on_click=_1)
# Row 6
